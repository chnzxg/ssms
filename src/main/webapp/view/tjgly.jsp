                ...
                fields: {
                    aname: {
                        ...
                        validators: {
                            ...
                            remote : {
                                url : '${pageContext.request.contextPath}/admin/checkaname.do',
                                message : "该商品名已存在",
                                delay : 500,
                                type : 'post',
                            }
        ...
        <div id="formdiv" style="width:100%;height:100%;">
            <form id="form" action="${pageContext.request.contextPath}/admin/addadmin.do" class="form-horizontal"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input autofocus type="text" class="form-control" id="aname" name="aname"
                        >
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div style="overflow: auto;margin-left: 15px;margin-bottom: 20px;height: 140px;width: 290px;">
                        <table>
                            <c:forEach items="${roles}" var="role" varStatus="s">
                                ...
                                <td><input type="checkbox" value="${role.rid}" name="rid"></td>
                                <td>${role.rname}</td>
                                <c:if test="${s.index%2==0}"></tr></c:if>
                            </c:forEach>
                        </table>
